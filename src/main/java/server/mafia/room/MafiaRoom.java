package server.mafia.room;

import server.ServerStarter;
import server.Status;
import server.mafia.Roles.Citizen;
import server.mafia.Roles.Mafia;
import server.mafia.Roles.Roles;
import server.mafia.Roles.RolesAdapter;
import server.mafia.server.ChatServerTh;
import server.mafia.server.DayTimer;
...
public class MafiaRoom extends ChatRoom {
    ...
    public static final int MIN_PERSON = 3;         //mafia게임 인원수
